...
//            TokenMemberInfoDto tokenMemberInfoDto = jwtService.parseAccessToken(token);
//
//            log.info("Member connected WebSocket. email : {}, name : {}", tokenMemberInfoDto.getEmail(), tokenMemberInfoDto.getName());
//
//            accessor.setUser(new UserPrincipal(String.valueOf(tokenMemberInfoDto.getId())));
//        } catch (Exception e) {
