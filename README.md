...
- 오늘의 뉴스
  ...
  - 사용자 활동 데이터를 기반으로 사용자의 취향에 맞는 뉴스 기사 3개 표시
  - 신규 가입 등으로 사용자 활동 데이터가 없을 시 최신 뉴스 추천
...
| 이름   | 역할               | 업무                                                                       |
| ------ | ------------------ | -------------------------------------------------------------------------- |
| 송강산 | 팀장, BE, FE, Data | CI/CD, 뉴스 데이터 크롤링 및 형태소 분석 작업, 뉴스 목록 조회, 뉴스 단일 조회, AI 회화 채팅 레포트 분석페이지 제작 |
| 백민정 | FE                 |                                                                            |
| 신동근 | BE, FE             | FE, BE 스켈레톤 구조 설계, 단어장 데이터 크롤링, Spring Security + JWT 설정, 회원 도메인, 단어장 도메인, AI 회화 채팅 도메인, 프로퍼티 암호화 설정, DB 마이그레이션 |
| 오기선 | FE                 |                                                                            |
